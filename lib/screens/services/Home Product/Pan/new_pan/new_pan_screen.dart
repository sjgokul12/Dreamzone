...
class NewPanScreen extends StatefulWidget {
  ...
  @override
  State<NewPanScreen> createState() => _NewPanScreenState();
}

class _NewPanScreenState extends State<NewPanScreen>
  ...
  Future<void> _submitPanForm() async {
    ...
    _razorpayService.openPaymentGateway(
      ...
      description: 'New PAN Application',
      name: 'DZI Infinity',
    ...
    return Column(
      children: [
        ...
        PanAccordionSection(
          ...
          subtitle: 'Application fee costs & processing details',
          leadingIcon: Icons.payment_outlined,
          onToggle: (idx) => setState(() => _expandedSectionIndex = idx),
          child: buildPanPaymentStepBox(
            title: 'New PAN Application Fee',
            subtitle: 'Includes government fee & processing',
            amount: _payableAmount,
          ),
        ),
      ],
