                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                // Row 1: Applicant Category & Business Name
                                _buildResponsiveRow(
                                  context,
                                  _buildDropdownField('Applicant Category *', _applicantCategory, ['New', 'Renewal'], (v) => setState(() => _applicantCategory = v!)),
                                  _buildInput('Business Name *', _businessNameCtrl, placeholder: 'BUSINESS NAME'),
                                ),
                                const SizedBox(height: 14),

                                // Row 2: Applicant's Name
                                _buildInput("Applicant's Name *", _applicantNameCtrl, placeholder: 'AS PER AADHAAR'),
                                const SizedBox(height: 14),

                                // Row 3: Father Name & Business Address
                                _buildResponsiveRow(
                                  context,
                                  _buildInput('Father Name *', _fatherNameCtrl, placeholder: 'FATHER NAME'),
                                  _buildInput('Business Address *', _businessAddressCtrl, placeholder: 'BUSINESS ADDRESS'),
                                ),
                                const SizedBox(height: 14),

                                // Row 4: PAN No. & Aadhaar Number
                                _buildResponsiveRow(
                                  context,
                                  _buildInput('PAN No. *', _panNoCtrl, placeholder: 'PAN NO.'),
                                  _buildInput('Aadhaar Number *', _aadhaarNoCtrl, isNum: true, placeholder: 'AADHAAR NUMBER'),
                                ),
                                const SizedBox(height: 14),

                                // Row 5: Shop Size & Product Name
                                _buildResponsiveRow(
                                  context,
                                  _buildInput('Shop Size (Sq. Ft.) *', _shopSizeCtrl, placeholder: 'SQ. FT.'),
                                  _buildInput('Product Name *', _productNameCtrl, placeholder: 'PRODUCT NAME'),
                                ),
                              ],
                            ),
                          ),
                              ...
                              builder: (context, constraints) {
                                ...
                                return isWide
                                    ? Row(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Expanded(child: _buildInput('Mobile Number *', _mobileNumberCtrl, isNum: true, placeholder: 'MOBILE NUMBER')),
                                          const SizedBox(width: 12),
                                          Expanded(child: _buildInput('Email ID *', _emailIdCtrl, placeholder: 'Email ID')),
                                          const SizedBox(width: 12),
                                          Expanded(
                                    ...
                                    : Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          _buildInput('Mobile Number *', _mobileNumberCtrl, isNum: true, placeholder: 'MOBILE NUMBER'),
                                          const SizedBox(height: 12),
                                          _buildInput('Email ID *', _emailIdCtrl, placeholder: 'Email ID'),
                                          const SizedBox(height: 12),
                                          _statesLoading
                                              ? const Padding(
                          ...
                          // SECTION 3: Upload Document (Matching Screenshot 2 UI)
                          _buildHeaderBanner('3. Upload Document.'),
                          Padding(
                            padding: const EdgeInsets.all(18.0),
                            child: Container(
                                ...
                                Center(
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: _loading ? null : _submitFssaiForm,
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: primaryTeal,
